...
public class Constants {
    ...
    public static final String TIMER_CHANNEL_NAME = "com.rikucherry.backgroundcountdowntimer.CHANNEL_NAME";
    public static final String ACTION_DELETE_NOTIFICATION = "com.rikucherry.backgroundcountdowntimer.ACTION_DELETE";

    public static final int TIMER_ID = 1234;
